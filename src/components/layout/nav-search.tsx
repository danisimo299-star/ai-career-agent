...
export function NavSearch() {
  ...
  return (
    <button
      ...
      className="border-border/60 bg-card hover:border-ring text-muted-foreground flex size-11 shrink-0 md:size-9 items-center justify-center gap-2 rounded-lg border text-left text-sm transition-colors duration-150 md:w-full md:max-w-sm md:justify-start md:py-2 md:pr-2 md:pl-3"
    >
